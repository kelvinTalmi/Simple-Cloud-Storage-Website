...
move_uploaded_file($_FILES["imageupload"]["tmp_name"],"files/".$imgnewfile);



$sql="INSERT INTO files(title,filename)VALUES(:title,:imgnewfile)";

$query=$conn->prepare($sql);

$query->execute([':title'=>$title,':imgnewfile'=>$imgnewfile]);
...
<div class='container'>
    ...
    <div style="display:none" id="add_link">
        ...
        <div id="morelinks">
            ...
            <div style='text-align:center' class='alert alert-success'>File Added Successfully</div>
